...
#---- Try adding gripper open command 
    ...
    robot_cmd = RobotCommandBuilder.synchro_se2_trajectory_point_command(
        ...
        frame_name=frame_name, params=mobility_param, build_on_command=gripper_open_command) #params=RobotCommandBuilder.mobility_params(footprint_R_body=footprint_R_body))

#----- Try adding arm command 
    ...
    #gripper_close_cmd = RobotCommandBuilder.claw_gripper_close_command(build_on_command=arm_command)
    sh0 = 0.0
    sh1 = -2.0
    el0 = 2.6
    el1 = 0.0
